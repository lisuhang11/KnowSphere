...
import ChatAttachmentDocumentPreview from '@/components/ChatAttachmentDocumentPreview.vue'
...
const MAIN_DRAWER_WIDTH_KEY = 'ks-chat-attachment-drawer-width'
